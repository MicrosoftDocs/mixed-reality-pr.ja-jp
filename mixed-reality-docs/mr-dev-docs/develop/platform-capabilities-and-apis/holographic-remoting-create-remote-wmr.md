...
## <a name="preview-streamed-content-locally"></a><span data-ttu-id="bb76e-183">ストリーミングされるコンテンツをローカルでプレビューする</span><span class="sxs-lookup"><span data-stu-id="bb76e-183">Preview streamed content locally</span></span>
