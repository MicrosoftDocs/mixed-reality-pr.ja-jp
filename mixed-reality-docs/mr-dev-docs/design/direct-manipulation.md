...
2D [スレート](slate.md)は、Web ブラウザーなどの 2D アプリ コンテンツをホストするホログラフィック コンテナーです。 直接操作による 2D スレートとの対話の設計概念は、物理的なタッチ画面を操作する場合と同じです。
...
:::row:::
    :::column:::
       ![グラブ アンド ドラッグ機能を示すグラフィック](images/manipulate-2d-slate-move.jpg)<br>
       **移動**<br>
       隅や端に手を動かして、一番近くにある操作アフォーダンスを表示します。 2D スレートの上部にあるホロバーをつかむことで、スレート全体を動かすことができます。
    :::column-end:::
    :::column:::
       ![スケール機能を示すグラフィック](images/manipulate-2d-slate-scale.jpg)<br>
        **スケール**<br>
...
:::row:::
    :::column:::
       ![オブジェクトの境界ボックスと移動機能を示すグラフィック](images/3d-object-manipulation-move.jpg)<br>
       **移動**<br>
       ユーザーの手が 3D オブジェクトに近づくとすぐに、境界ボックスおよび最も近いアフォーダンスが表示されます。 ユーザーは、境界ボックスをつかんでオブジェクト全体を移動できます。
    :::column-end:::
    :::column:::
       ![ユーザーがオブジェクトの端をつかんで回転させている様子を示すグラフィック](images/3d-object-manipulation-rotate.jpg)<br>
        **回転**<br>
        ユーザーは、端のアフォーダンスをつかんで回転できます。
    :::column-end:::
    :::column:::
       ![ユーザーがオブジェクトの隅をつかんでスケーリングしている様子を示すグラフィック](images/3d-object-manipulation-scale.jpg)<br>
       **スケール**<br>
...
:::row:::
    :::column:::
       ![ユーザーが小さなオブジェクトをつかんで移動する様子を示すグラフィック](images/instinctual-gestures-smallobject.jpg)<br>
       **小さなオブジェクト**<br>
    :::column-end:::
    :::column:::
       ![ユーザーが中程度のオブジェクトをつかんで移動する様子を示すグラフィック](images/instinctual-gestures-mediumobject.jpg)<br>
        **中程度のオブジェクト**<br>
    :::column-end:::
    :::column:::
       ![ユーザーが大きなオブジェクトをつかんで移動する様子を示すグラフィック](images/instinctual-gestures-largeobject.jpg)<br>
       **大きなオブジェクト**<br>
    :::column-end:::
:::row-end:::
