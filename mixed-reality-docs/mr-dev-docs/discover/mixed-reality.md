...
## <a name="next-discovery-checkpoint"></a><span data-ttu-id="ea92d-185">次の探索チェックポイント</span><span class="sxs-lookup"><span data-stu-id="ea92d-185">Next Discovery Checkpoint</span></span>
