...
_宝石とコミットメント_ は、マウス: _ポイント & クリック_ を使用してコンピューターを操作する方法と密接に関連した基本的な入力モデルです。
...
詳細と、使用可能な音声コマンドの一覧とその使用方法については、「 [音声](../out-of-scope/voice-design.md) コマンドの操作に関するガイダンス」を参照してください。
