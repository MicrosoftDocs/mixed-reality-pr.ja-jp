...
[プロジェクト] ウィンドウで、 **[資産]**  >  **[MRTK]**  >  **[SDK]**  >  **[Features]\(機能\)**  >  **[UX]**  >  **[Prefabs]\(プレハブ\)**  >  **[Menus]\(メニュー\)** フォルダーの順に移動し、 **[NearMenu4x1]** プレハブをクリックして [階層] ウィンドウにドラッグします。その [Transform]\(変換\) の **[Position]\(位置\)** を X = 0、Y = -0.4、Z = 0 に設定し、以下のように構成します。
