...
* お使いの UI が、 [応答性](https://msdn.microsoft.com/library/windows/apps/dn958435.aspx) の高い設計のベストプラクティスに従っていることを確認して、HoloLens の固有の解決策と DPI を最大限に活用しましょう。
