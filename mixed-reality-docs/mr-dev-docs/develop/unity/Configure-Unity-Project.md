...
---
# <a name="configuring-your-project-without-mrtk"></a>MRTK を使用しないプロジェクトの構成
...
* 使用可能な[プラットフォーム機能と api を](unity-development-overview.md#3-platform-capabilities-and-apis)確認する
