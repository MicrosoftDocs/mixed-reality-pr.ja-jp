...
* カメラは、30、24、20、15、および 5 fps で、次のモード (すべてのモードが16:9 の縦横比) をサポートしています。
  ...
  |  該当なし |  該当なし |  2048x1152 |  67度 |  高解像度の静止画像 | 
