...
Xbox のゲームパッドまたはキーボードとマウスを使用することだけを計画している場合は、コントローラーをペアリングする必要はありません。  コントローラーを使用する予定がある場合は、それらをペアリングする必要があります。
...
**オプション 2: 装着されている (机のスケールとも呼ばれる) エクスペリエンスのために** 、デスクで動作するように設定します。 スペースが大きい場合は、このオプションを使用することをお勧めします。 また、境界のないヘッドセットを使用することにもなります。 物理的な障害を回避するための境界がないため、1つの場所に保持する必要があります。 一部のアプリとゲームは、境界エクスペリエンスとして設計されていないため、意図したとおりに動作しないことがあります。
...
Windows Mixed Reality でサポートされる境界の最大サイズは、中央から 18x18ft (5.7 x 5.7 m) または 13 ft (4 m) の半径です。 境界サイズはアンカーポイントによって異なり、境界の安定性を危険にさらされる前に移動できるアンカーポイントからの距離によって決まります。  Windows Mixed Reality はステージの抽象化に基づいて構築されており、ステージは移動する領域です。 そのステージは1つのアンカーに依存しますが、ほとんどすべてのアプリが想定しているのは、Naopak と Oculus が1つの座標系を使用して作業する方法でもあります。  これは、内部では、アンカーポイントから離れた場所に移動するときに、ヘッドセットの追跡が安定した状態を維持するために必要です。  この境界は、物理的な障害を回避することを目的としています。問題の原因は、中心からさらに深くなります。  境界の最大サイズを決定するために、2つの要素がありました。 Windows Mixed Reality ヘッドセットが、境界とヘッドセットケーブルの長さに最適な部屋のスケールエクスペリエンスを提供できる最大距離。ほとんどの Windows Mixed Reality ヘッドセットは 10 ft (3 m) です。
...
AKG ヘッドホンとデュアルマイクアレイが統合された Samsung HMD Odyssey を購入していない場合は、マイクとヘッドホンの両方を備えたオーディオヘッドセットを入手し、ヘッドセットの 3.5-mm オーディオジャックに接続する必要があります。 ヘッドセットの 3.5-mm オーディオジャックは、ヘッドセットのバイザーの下に設置されています。または、ヘッドセットのモデルに応じて、ヘッドセットのバイザーに接続されている短いオーディオケーブルの最後にあります。
...
* 次の場合は、 **自動 upscaling (最適なパフォーマンス)** オプションを使用します。
    * お使いの PC は、高解像度のディスプレイでヘッドセットのグラフィックスハードウェアの最小要件を満たしていません
    * グラフィックスパフォーマンスの問題が発生しています
