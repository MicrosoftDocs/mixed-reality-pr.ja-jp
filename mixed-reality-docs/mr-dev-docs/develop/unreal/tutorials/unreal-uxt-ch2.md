...
最初に必要なのは、作業するプロジェクトです。 HoloLens 用の Unreal アプリを初めて作成する場合は、Epic Launcher から[サポート ファイルをダウンロードする](https://docs.microsoft.com/windows/mixed-reality/develop/unreal/tutorials/unreal-uxt-ch6#packaging-and-deploying-the-app-via-device-portal)必要があります。
...
1. **[コンテンツ ブラウザー]** で **[新規追加] > [新しいフォルダー]** の順にクリックし、 **[ブループリント]** という名前を付けます。 
